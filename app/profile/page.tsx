  ...
  return (
    <main style={{minHeight: '100vh', background: '#faf8f4', paddingBottom: '80px'}}>
      ...
      <div style={{maxWidth: '680px', margin: '0 auto', padding: '24px'}}>
        ...
        {/* PROFILE CARD */}
        <div style={{
          background: '#fff', borderRadius: '16px', border: '1px solid #e8e4de',
          ...
          <div style={{
            ...
            justifyContent: 'center', fontSize: '22px', color: '#fff', fontWeight: '700'
          }}>
        ...
        {listings.length === 0 ? (
          <div style={{
            background: '#fff', borderRadius: '16px', border: '1px solid #e8e4de',
            padding: '40px', textAlign: 'center', color: '#8a8a8a', fontSize: '14px'
          }}>
            No listings yet.{' '}
            <span
              onClick={() => router.push('/post')}
              style={{color: '#4a8c5c', cursor: 'pointer', textDecoration: 'underline'}}
            >
              Post your first one →
            </span>
          </div>
          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: '12px'}}>
            {listings.map((item) => (
              <div key={item.id} style={{
                background: '#fff', borderRadius: '14px', border: '1px solid #e8e4de',
                padding: '16px', display: 'flex', alignItems: 'center', gap: '14px'
              }}>
                <div style={{
                  width: '56px', height: '56px', borderRadius: '10px',
                  background: '#e8f4f0', overflow: 'hidden', flexShrink: 0,
                ...
                <div style={{flex: 1}}>
                  ...
                  <div style={{fontSize: '13px', color: '#4a8c5c', fontWeight: '500'}}>
                ...
                <div style={{display: 'flex', gap: '8px'}}>
                  <button
                    ...
                    style={{
                      background: '#e8f4f0', color: '#1a3a2a', border: 'none',
